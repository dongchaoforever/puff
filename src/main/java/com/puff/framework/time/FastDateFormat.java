...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
	 ...
	 */
	protected FastDateFormat(final String pattern) {
		this(pattern, TimeZone.getDefault(), Locale.getDefault(Locale.Category.FORMAT), null);
	}
	...
	protected FastDateFormat(final String pattern, final TimeZone timeZone) {
		this(pattern, timeZone, Locale.getDefault(Locale.Category.FORMAT), null);
	}
